...
This repository contains code implementations for a LoRaWAN end node using the STM32WL55JC1 Nucleo Board.
Here below you find both the description of the complete repository, and the description of how to use the files in this branch, to set up a basic LoRaWAN_End_Node example.
...
# Setting Up a basic example for STM32WL55JC1 as a LoRaWAN End-Node
## (By using the files in this branch)
